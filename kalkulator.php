...
input#equal{
 ...
 border: 1px solid #b32a00;
   ...
   <meta charset="utf-8">
   <meta name="description" content="AAF Exploiter">
   <!-- Somehow I got an error, so I comment the title, just uncomment to show -->
   <!-- <title>Calculator AAF Exploiter</title> -->
   <link rel="stylesheet" href="style.css">
   <link rel="https://a.top4top.io/p_1776okki20.png" href="https://a.top4top.io/p_1776okki20.png
   ">
   <script src="https://code.jquery.com/jquery-3.4.1.js"></script>
 </head>
 <body>
   <div class="center">
       <h1><font color="white">KALKULATOR</font></a></h1>
     <form name="forms">
       ...
       <h1><font color="yellow">Fathan Raffi</font></h1>
</form>
</div>
<script>
